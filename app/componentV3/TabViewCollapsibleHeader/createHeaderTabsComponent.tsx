...
class CollapsibleHeaderTabView<T extends Route> extends React.Component<ForwardTabViewProps<T>> {
  ...
  render() {
    return (
      <GestureContainer renderTabViewContainer={this.renderTabViewContainer} {...this.props} />
    );
  }
}

class SlideTabView<T extends Route> extends React.Component<
