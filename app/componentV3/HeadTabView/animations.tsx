...
export function pullRefreshAnimatedStyles(
  refreshAnimated: Animated.Value | Animated.AnimatedSubtraction,
  refreshHeight: number,
  pullExtendedCoefficient: number = 0.1,
) {
...
export function pullRefreshViewAnimatedStyles(
  refreshAnimated: Animated.Value | Animated.AnimatedSubtraction,
  refreshHeight: number,
  pullExtendedCoefficient: number = 0.1,
) {
...
export function tabviewTransAnimatedStyles(
  tabviewTrans: Animated.Value | Animated.AnimatedSubtraction,
  headerHeight: number,
  isRefreshing = false,
  refreshHeight = 0,
) {
  const inputRange = isRefreshing
    ? [-1, 0, refreshHeight, refreshHeight + headerHeight, refreshHeight + headerHeight + 1]
    : [-1, 0, headerHeight, headerHeight + 1];
  const outputRange = isRefreshing
    ? [refreshHeight, refreshHeight, 0, -headerHeight, -headerHeight]
