...
>;
export function HPageViewHoc<T = any>(
  component: typeof FlatList,
  config?: SceneConfig,
): React.ForwardRefExoticComponent<
  React.PropsWithoutRef<FlatListProps<T>> & React.RefAttributes<FlatList<T>> & NormalSceneBaseProps
>;
export function HPageViewHoc<T = any>(
  component: typeof SectionList,
  config?: SceneConfig,
): React.ForwardRefExoticComponent<
...
export interface FitTabViewBase
  extends Omit<
      CollapsibleHeaderProps,
      'scrollEnabled' | 'refreshHeight' | 'frozeTop' | 'overflowHeight'
    >,
    TabViewContainerBaseProps {
  currentIndex: number;
}
