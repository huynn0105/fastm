 ...
 * @author: Trung Nguyen
 */
export default class PCustomTextInput extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      isFocused: undefined,
  ...
  render() {
    ...
    return (
      <View
        style={{
          ...containerStyle,
          borderColor: this.state.isFocused ? Colors.primary2 : Colors.gray4,
          borderWidth: 1,
        }}
      >
        <View style={{ ...styles.textInputContainer }}>
          {isShownLeftIcon ? this._renderLeftIcon(icon) : null}
          {this._renderTextInput()}
          {!hideShowClearTextButton && value?.length > 0 ? this._renderClearTextButton() : null}
        </View>
