...
class NotiRow extends PureComponent {
  ...
  render() {
    const { image, name, title, content, contentHTML, hasAction, index, canPressRow, isExpend, unreadNumberColpand } = this.props;
    ...
    return (
      <Animatable.View
        ref={ref => { this.containViewRef = ref; }}
