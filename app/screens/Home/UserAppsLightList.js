...
import { UserAppLight, UserApp } from 'app/models';
...
class UserAppsLightList extends Component {
...
UserAppsLightList.propTypes = {
  data: PropTypes.arrayOf(PropTypes.instanceOf(UserAppLight)),
  isLastRowSeparatorHidden: PropTypes.bool,
  onItemPress: PropTypes.func,
};

UserAppsLightList.defaultProps = {
  data: [],
  isLastRowSeparatorHidden: false,
  onItemPress: () => { },
};

export default UserAppsLightList;
