      ...
      <View style={[styles.row, style]}>
        <KJTouchableOpacity onPress={this.onPress}>
          <View style={[styles.container]}>
            ...
            <AppText style={[styles.details, detailsStyle]}>{details}</AppText>
            {isArrowHidden ? null : <Accessory onPress={this.onAccessoryPress} />}
          </View>
          {isSeperatorHidden ? null : <Seperator />}
        </KJTouchableOpacity>
      </View>
    );
  }
...
const Accessory = (props) => (
  <KJTouchableOpacity onPress={props.onPress}>
    <Image
      style={{
        width: 20,
        height: 20,
