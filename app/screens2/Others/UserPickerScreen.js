...
class UserPickerScreen extends Component {
  ...
  getUsersPlaceholderText() {
    const placeholderText = 'Chọn người đã giới thiệu và hướng dẫn bạn tham gia, nếu không có vui lòng bấm\n';
        ...
        <View style={styles.emptyContainer}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
            <KJTouchableOpacity
              ...
              activeOpacity={0.65}
            >
              <AppText style={[styles.skipText, { textDecorationLine: 'underline' }]}>
                Bỏ qua
              </AppText>
            </KJTouchableOpacity>
        ...
        <View style={styles.userItem}>
          <View style={styles.userItemRow}>
            ...
            <View style={styles.userItemContent}>
              <AppText style={[styles.userNameText, isSelected ? { fontWeight: '800' } : {}]}>
                {`${user.fullName}`}
              </AppText>
              <AppText style={[styles.userPhoneText, isSelected ? { fontWeight: '800' } : {}]}>
            ...
            </View>
            {
              <View>
                <KJTouchableOpacity
                  ...
                  onPress={() => this.onUserSelect(user)}
                >
                  <AppText style={[styles.titleText, { marginTop: 6, marginRight: 6 }]}>
