...
class OtpConfirmScreen extends Component {
  ...
  renderTitle() {
    ...
    return (
      <AppText style={styles.titleText}>
        <AppText style={{ color: '#202020' }}>{Strings.otp_call_message1}</AppText>
        <AppText style={{ color: '#202020', fontWeight: '600' }}>{` ${userPhoneNumber} `}</AppText>
        <AppText style={{ color: '#202020' }}>{Strings.otp_call_message2}</AppText>
        <AppText style={{ color: '#202020', fontWeight: '600' }}>
  ...
  renderHint() {
    return <AppText style={styles.hintText}>{Strings.otp_hint}</AppText>;
  }
  renderOtpInput() {
  ...
  renderOtpResendButton() {
    ...
    return (
      <AppText style={styles.countDownText}>{`MFAST sẽ gọi trong ${countDownSecs} giây`}</AppText>
    );
  }
  render() {
    return (
