  ...
  constructor() {
    ...
    this.renderFooter = () => {
      if (this.props.renderFooter) {
        return (
          <View style={!IS_IOS && this.props?.inverted && { scaleY: -1 }}>
    ...
    this.renderRow = ({ item, index }) => {
      ...
      if (messages && user) {
        ...
        return (
          <View style={!IS_IOS && inverted && { scaleY: -1 }}>
    ...
    this.renderChatEmpty = () => {
      if (this.props.renderChatEmpty) {
        return this.props.inverted ? (
          ...
          <View
            style={[styles.emptyChatContainer, !IS_IOS && this?.props?.inverted && { scaleY: -1 }]}
          >
            {this.props.renderChatEmpty()}
          </View>
        );
    ...
    this.renderHeaderWrapper = () => (
      <View style={[styles.headerWrapper, !IS_IOS && this?.props?.inverted && { scaleY: -1 }]}>
        {this.renderLoadEarlier()}
      </View>
    );
    this.onLayoutList = () => {
    ...
    return (
      <View style={this.props.alignTop ? styles.containerAlignTop : styles.container}>
        ...
        <FlatList
          ...
          style={[styles.listStyle, !IS_IOS && inverted && { scaleY: -1 }]}
          contentContainerStyle={styles.contentContainerStyle}
          renderItem={this.renderRow}
          {...this.props.invertibleScrollViewProps}
          ListEmptyComponent={this.renderChatEmpty}
          inverted={inverted && IS_IOS}
