...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new biz.cosee.native_image_cropper.NativeImageCropperPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin native_image_cropper_android, biz.cosee.native_image_cropper.NativeImageCropperPlugin", e);
    }
    try {
