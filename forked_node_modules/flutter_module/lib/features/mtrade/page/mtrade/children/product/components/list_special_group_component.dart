...
class ListSpecialGroupComponent extends StatefulWidget {
  const ListSpecialGroupComponent({Key? key}) : super(key: key);

  @override
  State<ListSpecialGroupComponent> createState() => _ListSpecialGroupComponentState();
}

class _ListSpecialGroupComponentState extends State<ListSpecialGroupComponent> {
    ...
    return BlocListener<MTradeProductGroupCubit, MTradeProductGroupState>(
      ...
      listener: (context, state) {
        if (state.productStatus.isSuccess && AppData.instance.selectedSpecialGroup != null) {
          _hasAutoScroll = true;
          final index = state.specialGroups.indexWhere((e) => e.code == state.selectedSpecialGroup?.code && AppData.instance.selectedSpecialGroup != null);
          if (index >= 0) {
                            ...
                            child: AppSplashButton(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: isSelected ? UIColors.primaryColor : UIColors.white,)
                                ),
                                child: Column(
                                  children: [
                                    AppImage.network(
