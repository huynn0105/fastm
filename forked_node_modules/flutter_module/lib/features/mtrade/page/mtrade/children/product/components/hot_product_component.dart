...
class HotProductComponent extends StatelessWidget {
  const HotProductComponent({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MTradeHotProductCubit, MTradeHotProductState>(
