...
import '../../../../cubit/campaign/mtrade_campaign_cubit.dart';
...
@RoutePage()
class MTradeProductTabPage extends StatelessWidget implements AutoRouteWrapper {
  const MTradeProductTabPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return const MTradeProductView();
  }
}
