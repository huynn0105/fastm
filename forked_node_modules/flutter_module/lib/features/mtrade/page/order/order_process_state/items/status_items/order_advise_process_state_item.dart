...
class OrderAdviseProcessStateItem extends StatelessWidget
    with OrderProcessStateMixin {
  const OrderAdviseProcessStateItem({
    Key? key,
    required this.data,
  ...
  Widget build(BuildContext context) {
    ...
    return AppSplashButton(
      ...
      onTap: () {
        RedirectUtil.openMFastDeepLink(data.urlDetail);
      },
      child: SizedBox(
        height: 62,
        child: Row(
