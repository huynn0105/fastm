...
part 'mtrade_hot_product_state.dart';

class MTradeHotProductCubit extends Cubit<MTradeHotProductState> {
  MTradeHotProductCubit() : super(const MTradeHotProductState());
