...
part 'mtrade_filtered_promotion_product_state.dart';

class MTradeFilteredPromotionProductCubit extends Cubit<MTradeFilteredPromotionProductState> {
  MTradeFilteredPromotionProductCubit() : super(const MTradeFilteredPromotionProductState());
