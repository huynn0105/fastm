...
class PersonalSettingRepository {
  ...
  Future<BaseModel<MentorRatingModel>> getMentorRating() {
    return ApiProvider.instance.personalSetting.getMentorRating();
  }

  Future<BaseModel<List<VisibleSettingModel>>> getVisibleSettings() {
    return ApiProvider.instance.personalSetting.getVisibleSettings();
  }

  Future<BaseModel<void>> updateVisibleSetting(UpdateSettingPayload payload) {
    return ApiProvider.instance.personalSetting.updateVisibleSetting(payload);
  }
  Future<BaseModel<CoreAgent>> getCoreAgent() {
    return ApiProvider.instance.personalSetting.getCoreAgent();
  }
}
