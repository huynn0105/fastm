...
class PersonalSettingComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isHeaderTickerScrollable = headers.length > 4;
    final headerTicketItemWidth = (AppSize.instance.width - 32) / 4;
          ...
          ? TicketWidget(
              ...
              leading: Scrollbar(
                child: SingleChildScrollView(
                  ...
                  physics: isHeaderTickerScrollable
