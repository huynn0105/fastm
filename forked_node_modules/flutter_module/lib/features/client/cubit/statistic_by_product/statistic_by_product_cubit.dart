...
part 'statistic_by_product_state.dart';

class StatisticByProductCubit extends Cubit<StatisticByProductState> {
  StatisticByProductCubit() : super(const StatisticByProductState());
  ...
  fetchData() async {
    ...
    final result = await repository.getStatisticByProduct();
    if (result.status) {
      emit(state.copyWith(
