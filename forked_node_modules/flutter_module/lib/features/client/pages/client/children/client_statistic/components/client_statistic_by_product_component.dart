...
class ClientStatisticByProductComponent extends StatelessWidget {
  const ClientStatisticByProductComponent({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<StatisticByProductCubit, StatisticByProductState>(
      listener: (context, state) {
        _onListenStateChange(context);
      },
      builder: (context, state) {
        final cubit = context.read<StatisticByProductCubit>();
