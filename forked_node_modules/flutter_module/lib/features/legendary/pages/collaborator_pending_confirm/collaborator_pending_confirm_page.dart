...
import 'package:flutter_module/features/legendary/cubit/collaborator_pending_confirm/collaborator_pending_confirm_cubit.dart';
import 'package:flutter_module/features/legendary/cubit/legendary_review/legendary_review_cubit.dart';
import 'package:flutter_module/features/legendary/pages/new_supporter/components/rating_component.dart';
...
class CollaboratorPendingConfrimPage extends StatelessWidget implements AutoRouteWrapper {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<CollaboratorPendingConfirmCubit, CollaboratorPendingConfirmState>(
                        ...
                        Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              AppSplashButton(
                                onTap: () {
                                  context.pushRoute(ChatRoute(chatUserID: state.collaborator?.userId));
                                },
                                child: const AppImage.asset(
                                  asset: 'icon_chat',
                                  height: 28,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        AppSplashButton(
                          onTap: () {
                            context.pushRoute(ChatRoute(chatUserID: collaborator?.userId));
                          },
                          child: const AppImage.asset(
                            asset: 'icon_chat',
                            height: 28,
