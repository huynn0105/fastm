...
import 'package:flutter_module/common/enum/legendary/legendary_overview_content.dart';
...
import 'package:flutter_module/features/legendary/cubit/legendary_collaborator/legendary_collaborator_cubit.dart';
...
import 'package:flutter_module/features/legendary/pages/legendary/components/legend_no_login_component.dart';
import 'package:flutter_module/features/legendary/pages/legendary/components/utility_bottom_sheet_component.dart';
import 'package:flutter_module/features/legendary/pages/legendary/legendary_web_view_page.dart';
import 'package:flutter_module/features/personal_setting/cubit/mentor_rating/mentor_rating_cubit.dart';
...
class LegendaryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const LegendaryWebViewPage();
...
class _LegendaryPageState extends State<_LegendaryPage> with SingleTickerProviderStateMixin {
          ...
          listener: (context, state) {
            if (state.hasLoggedIn) {
              context.read<LegendaryCollaboratorCubit>().fetchData(
                rank: context.read<LegendaryHierUserInfoCubit>().state.data?.rank?.level?.level,
              );
            } else {
              context.read<LegendaryCollaboratorCubit>().clearData();
            }
          },
        ),
      ],
  ...
  _onScrollToChart(LegendaryOverviewContent chart) async {
    ...
    if (box != null) {
      ...
      final gapHeight = Platform.isIOS ? GAP_HEIGHT * 1.9 : GAP_HEIGHT * 2;
