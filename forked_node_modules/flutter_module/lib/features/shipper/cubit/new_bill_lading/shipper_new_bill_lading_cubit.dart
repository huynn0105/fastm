...
part 'shipper_new_bill_lading_state.dart';

class ShipperNewBillLadingCubit extends Cubit<ShipperNewBillLadingState> {
  ShipperNewBillLadingCubit() : super(const ShipperNewBillLadingState());
  ...
  fetchData({bool showLoading = true, bool loadmore = false}) async {
    ...
    final result = await _repository.getListBillLading(
      step: BillLadingType.newOrder.value,
