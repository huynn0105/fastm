...
part 'shipper_completed_bill_lading_state.dart';

class ShipperCompletedBillLadingCubit extends Cubit<ShipperCompletedBillLadingState> {
  ShipperCompletedBillLadingCubit() : super(const ShipperCompletedBillLadingState());
  ...
  fetchData({bool showLoading = true, bool loadmore = false}) async {
    ...
    final result = await _repository.getListBillLading(
      step: BillLadingType.completedOrder.value,
