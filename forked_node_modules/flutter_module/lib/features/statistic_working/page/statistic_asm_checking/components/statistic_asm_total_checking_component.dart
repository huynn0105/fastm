...
class StatisticAsmTotalCheckingComponent extends StatelessWidget with StatisticWorkingMixin {
  const StatisticAsmTotalCheckingComponent({super.key});
          ...
          builder: (context, state) {
            ...
            return Padding(
              ...
              child: StatisticListComponent(
                ...
                onRefresh: context.read<StatisticAsmTotalCheckingCubit>().refreshData,
