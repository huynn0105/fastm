...
@RoutePage()
class ChatGeneralVideoPage extends StatelessWidget {
  const ChatGeneralVideoPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ChatGeneralMediaCubit, ChatGeneralMediaState>(
      builder: (context, state) {
        final medias = FirebaseDatabaseUtil.getMediasFromMessages(state.videos);
  ...
  _onDeleteMessage(BuildContext context, {String? messageID}) async {
    ...
    // mediaCubit.deletedVideoMessage(messageID: messageID);
    if (context.mounted) {
    ...
    mediaCubit.getVideoMessagesInThread();
  }
}
