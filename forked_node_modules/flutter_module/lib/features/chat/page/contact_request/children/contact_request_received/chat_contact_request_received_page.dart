...
import 'package:flutter_module/features/chat/page/contact_request/components/list_received_contacts_component.dart';

@RoutePage()
class ChatContactRequestReceivedPage extends StatelessWidget {
  const ChatContactRequestReceivedPage({super.key});
