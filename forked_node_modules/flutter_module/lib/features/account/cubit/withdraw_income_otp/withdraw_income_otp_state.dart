...
part of 'withdraw_income_otp_cubit.dart';

class WithdrawIncomeOTPState extends Equatable {
  ...
  WithdrawIncomeOTPState copyWith({
    BlocStatus? status,
