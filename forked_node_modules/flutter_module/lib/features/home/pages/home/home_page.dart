  ...
  void _onNextUserGuide({bool isContentTap = false}) {
    if (tutorialCoachMark.isShowing) {
      ...
      if (currentStep == MenuType.tip) {
        scrollController
            .animateTo(-distance, duration: const Duration(milliseconds: 500), curve: Curves.linear)
            .then((_) {
        ...
        _debounce.run(() {
          scrollController.scrollToIndex(currentStep.index, preferPosition: AutoScrollPosition.begin).then((_) {
            if (isContentTap) {
            ...
            child: BlocConsumer<HomePageCubit, HomePageState>(
              listener: (context, state) {
                if (state.status == BlocStatus.success &&
                  ...
                  scrollController
                      .scrollToIndex(MenuType.finance.index, preferPosition: AutoScrollPosition.begin)
                      .then((_) {
