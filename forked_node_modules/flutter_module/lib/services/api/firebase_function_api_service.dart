...
import 'package:flutter_module/services/api/interceptor/convert_interceptor.dart';
...
class FirebaseFunctionAPIService extends FirebaseFunctionAPIServiceProtocol {
  ...
  Dio init() {
    if (dio == null) {
      ...
      dio!.options.baseUrl = EnvData.instance.firebaseFunctionUrl;
  ...
  Future<BaseResponse> requestData(EndpointType endpoint) async {
    ...
    if (!isNetworkAvailable) {
      return BaseResponse(status: false, errorMessage: "Network is not available");
    }

    final header = <String, dynamic>{};

    header['Authorization'] =
    'Basic ${base64Encode(utf8.encode('${EnvData.instance.apiUserName}:${EnvData.instance.apiPassword}'))}';
