...
class MFastAppInfoModel {
  ...
  double? ekycValidScore;
  List<String>? systemThreadId;
  ChatBotModel? highlightChatBot;
  List<ChatBotModel>? chatBots;
  String? incomeTabUrl;
  bool? isEcomRegistration;
  ...
  MFastAppInfoModel({
    ...
    this.ekycValidScore,
    this.systemThreadId,
    this.highlightChatBot,
    this.chatBots,
    this.incomeTabUrl,
    this.isEcomRegistration,
  });
  ...
  MFastAppInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    ctvUserMFastPdf = json['ctvUserMFastPdf'];
    ...
    ekycValidScore = json['ekycValidScore'];
    ...
    highlightChatBot = json['highlightChatBot'] != null ? ChatBotModel.fromJson(json['highlightChatBot']) : null;
    chatBots =
        json["chatBots"] == null ? null : (json["chatBots"] as List).map((e) => ChatBotModel.fromJson(e)).toList();
    incomeTabUrl = json['incomeTabUrl'];
    isEcomRegistration = json['isEcomRegistration'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ctvUserMFastPdf'] = ctvUserMFastPdf;
    ...
    data['ekycValidScore'] = ekycValidScore;
    data['systemThreadId'] = systemThreadId;
    if (highlightChatBot != null) {
      data['highlightChatBot'] = highlightChatBot!.toJson();
    }
    if (chatBots != null) {
      data["chatBots"] = chatBots?.map((e) => e.toJson()).toList();
    }
    data['incomeTabUrl'] = incomeTabUrl;
    data['isEcomRegistration'] = isEcomRegistration;
    return data;
  }
