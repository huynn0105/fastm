...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  override func application(
    ...
    GMSServices.provideAPIKey(FlutterConfigPlugin.env(for: "IOS_GOOGLE_API_KEY"))
    let sdkConfig = MoEngageSDKConfig(withAppID: FlutterConfigPlugin.env(for: "MOE_API_KEY"))
